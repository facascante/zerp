...
class Tblprocess
{
     ...
     * Set intmoduleid
     *
     * @param \Realms\Entity\Tblmodules $intmoduleid
     * @return Tblprocess
     */
    public function setIntmoduleid(\Realms\Entity\Tblmodules $intmoduleid)
    {
     ...
     * Get intmoduleid
     *
     * @return \Realms\Entity\Tblmodules 
     */
