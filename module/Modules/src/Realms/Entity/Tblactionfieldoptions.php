...
class Tblactionfieldoptions
{
     ...
     * @var integer
     *
     * @ORM\Column(name="intActionFieldOptionID", type="integer", precision=0, scale=0, nullable=false, unique=false)
     * @ORM\Id
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="intActionFieldID", referencedColumnName="intActionFieldID", nullable=true)
     * })
     */
