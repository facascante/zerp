...
class Tblactiontypes
{
     ...
     * @var integer
     *
     * @ORM\Column(name="intActionTypeID", type="integer", precision=0, scale=0, nullable=false, unique=false)
     * @ORM\Id
     ...
     * @var string
     *
     * @ORM\Column(name="intActionTypeName", type="string", length=45, precision=0, scale=0, nullable=true, unique=false)
     */
