...
class Tblusers
{
    ...
    /**
     * @var \Api\Entity\Tbluserstatus
     *
     * @ORM\ManyToOne(targetEntity="Api\Entity\Tbluserstatus")
     * @ORM\JoinColumns({
     ...
     * Set intuserstatusid
     *
     * @param \Api\Entity\Tbluserstatus $intuserstatusid
     * @return Tblusers
     */
    public function setIntuserstatusid(\Api\Entity\Tbluserstatus $intuserstatusid = null)
    {
     ...
     * Get intuserstatusid
     *
     * @return \Api\Entity\Tbluserstatus 
     */
