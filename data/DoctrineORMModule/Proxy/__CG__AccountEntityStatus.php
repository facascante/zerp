 ...
 */
class Status extends \Account\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Account\\Entity\\Status' . "\0" . 'statusid', '' . "\0" . 'Account\\Entity\\Status' . "\0" . 'category', '' . "\0" . 'Account\\Entity\\Status' . "\0" . 'status');
        }
