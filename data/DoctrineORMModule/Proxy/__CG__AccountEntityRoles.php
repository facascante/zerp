 ...
 */
class Roles extends \Account\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Account\\Entity\\Roles' . "\0" . 'roleid', '' . "\0" . 'Account\\Entity\\Roles' . "\0" . 'role');
        }
